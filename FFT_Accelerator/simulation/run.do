...
vcom -2008 -explicit  -work presynth "${PROJECT_DIR}/stimulus/FFT_AHB_Wrapper_tb.vhd"

vsim -L SmartFusion2 -L presynth -L COREAPB3_LIB -L COREAHBLITE_LIB -L COREAHBLSRAM_LIB  -t 10ps presynth.testbench
add wave /testbench/*
run 1000ns
